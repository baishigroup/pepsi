...
public interface IMaterialCService {
    /**
     * 添加商品信息
     * @param material
     * @return
     ...
     * @return
     */
    List<Material> queryMaterialPager(Material material, PageBean pageBean);
     ...
     * @return
     */
    Boolean checkIsExist(String filedName,String filedValue,String idFiled,String objectID);
